...
/**
 * ImageUploader wraps FileUploader and adds a few more progress events
 */
function ImageUploader(form) {
  this.fileUploader = new FileUploader(form);
}
...
ImageUploader.prototype.upload = function (fileField, url) {
  var deferred = $.Deferred();
  var upload = this.fileUploader.upload(fileField, url);
